...
<nav class="navbar navbar-expand-lg navbar-light custom-bg">
  <a class="navbar-brand" href="/home">
   ...
   <i><b><span class="text-color">ICIN Bank</span></b></i>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
       ...
       <li class="nav-item active  ml-5">
        <a class="nav-link text-color" href="customerlogin"><b><span class="text-color"> Customer Login</span></b></a>
       </li>
      
       <li class="nav-item active  ml-5">
        <a class="nav-link text-color" href="adminlogin"><b><span class="text-color"> Admin Login</span></b></a>
       </li>
    </ul>
   </div>
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
     ...
     %>
      ...
      %>
      <li class="nav-item active  ml-5">
        <a class="nav-link" href="withdraw"><b><span class="text-color">Withdraw </span></b><span class="sr-only">(current)</span></a>
      </li>
      
      <li class="nav-item active  ml-5">
        <a class="nav-link" href="deposit"><b><span class="text-color">Deposit </span></b><span class="sr-only">(current)</span></a>
      </li>
      ...
      <li class="nav-item active  ml-5" data-toggle="modal" data-target=".balancemodal">
        <a class="nav-link" href="#"><b><span class="text-color"> Check Balance</span></b><span class="sr-only">(current)</span></a>
      </li>
      
       <li class="nav-item active  ml-5" data-toggle="modal" data-target=".fetchmodal">
        <a class="nav-link" href="#"><b><span class="text-color"> Account Detail</span></b><span class="sr-only">(current)</span></a>
      </li>
